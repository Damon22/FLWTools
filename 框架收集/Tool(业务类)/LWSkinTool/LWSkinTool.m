...
+ (UIImage *)imageName:(NSString *)name
{
    ...
    //拼接图片名称    皮肤所在的文件夹
    NSString *skinImagePath = [NSString stringWithFormat:@"skin/%@/%@",LWSkinName,name];
...
+ (void)loadSkinColor
{
    //1. 读取plist      plist所在的文件夹
    NSString *colorPlistName = [NSString stringWithFormat:@"skin/%@/skinColor.plist",LWSkinName];
